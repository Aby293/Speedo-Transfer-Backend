...
public class TransferServiceExceptionHandler {
    ...
    public ResponseEntity<Object> accountAlreadyExistExceptionHandling(CustomerAlreadyExistException exception, WebRequest request) {
    ...
    public ResponseEntity<Object> accountNotFoundExceptionHandling(CustomerNotFoundException exception, WebRequest request) {
        return new ResponseEntity<>(new ErrorDetails(LocalDateTime.now(), exception.getMessage(),
    ...
    public ResponseEntity<Object> invalidAccountCurrencyExceptionHandling(InvalidAccountCurrencyException exception, WebRequest request) {
        return new ResponseEntity<>(new ErrorDetails(LocalDateTime.now(), exception.getMessage(),
                request.getDescription(false), HttpStatus.BAD_REQUEST), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(NoDefaultAccountException.class)
    public ResponseEntity<Object> noDefaultAccountExceptionHandling(NoDefaultAccountException exception, WebRequest request) {
        return new ResponseEntity<>(new ErrorDetails(LocalDateTime.now(), exception.getMessage(),
                request.getDescription(false), HttpStatus.BAD_REQUEST), HttpStatus.BAD_REQUEST);
    }
